...
class Project extends Model
{
    ...
    public static function getProjectStatus()
    {
        ...
        {
            $on_going  = Userprojects::join('projects', 'userprojects.project_id', '=', 'projects.id')->where('projects.status', '=', 'in_progress')->where('user_id', '=', \Auth::user()->id)->count();
            ...
            $completed = Userprojects::join('projects', 'userprojects.project_id', '=', 'projects.id')->where('projects.status', '=', 'complete')->where('user_id', '=', \Auth::user()->id)->count();
            $canceled = Userprojects::join('projects', 'userprojects.project_id', '=', 'projects.id')->where('projects.status', '=', 'canceled')->where('user_id', '=', \Auth::user()->id)->count();
            $total     = $on_going + $on_hold + $completed + $canceled;
    ...
    {
        return TaskStage::where('created_by', '=', $this->created_by)->orderBy('order', 'desc')->first();
    }
