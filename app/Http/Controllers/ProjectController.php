...
class ProjectController extends Controller
{
    ...
    public function destroyProjectUser($project_id, $userId)
    {

        $projectUser = ProjectUser::where('project_id', $project_id)->where('user_id', $userId)->first();
        $projectUser->delete();
        return redirect()->back()->with('success', __('User successfully deleted from project.'));
