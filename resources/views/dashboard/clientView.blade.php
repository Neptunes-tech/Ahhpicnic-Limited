...
@endphp
    ...
    <div class="row">
        <!-- @if(!empty($chartData))
            <div class="{{ (\Auth::user()->type == 'Super Admin')? 'col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12' : 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12' }}">
                <div>
                    @if(\Auth::user()->type != 'Super Admin')
                        <h4 class="h4 font-weight-400 float-left">{{__('Invoice & Payment')}}</h4>
                    @endif
                </div>
                <div class="card bg-none">
                    <div class="card-body">
            ...
            <div class="card bg-none">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0" id="datatable">
                        ...
                        @if(!empty($invoices))
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>36543563578634</td>
                                    @if(Auth::user()->type != 'Client')
                                        <td>
                                            @can('View Invoice')
                                                <a href="{{route('invoices.show',$invoice->id)}}" class="view-text"> <i class="fas fa-eye"></i> {{ __('View') }}</a>
                                            @endcan
                                        </td>
                                    @endif
                                </tr>
                        ...
                        @else
                            <tr>
                                <td colspan="2" class="text-center">{{__('No data available in table')}}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
