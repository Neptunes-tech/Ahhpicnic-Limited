                                                ...
                                                <p class="mb-0">
                                                    @foreach($deal->users as $user)
                                                        ...
                                                        <a href="#" class="btn btn-sm mr-1 p-0 rounded-circle">
                                                            ...
                                                            <img alt="image" data-toggle="tooltip" data-original-title="{{$user->name}}" @if(!empty($user->avatar)) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('assets/img/avatar/avatar-1.png')}}" @endif class="rounded-circle " width="25" height="25">
                                                        </a>
                                                    @endforeach
                                                </p>
                                            </div>
