...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <select class="form-control form-control-light select2" name="time_hour" id="time_hour" required="">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <select class="form-control form-control-light select2" name="time_minute" id="time_minute" required>
