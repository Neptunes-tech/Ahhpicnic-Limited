  ...
  <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <ul class="nav nav-tabs my-3">
              <li class="nav-item">
                <a class="active" data-toggle="tab" href="#staff" role="tab" aria-controls="home" aria-selected="true">Staff</a>
              </li>
              <li class="nav-item">
                <a class="" data-toggle="tab" href="#crm" role="tab" aria-controls="home" aria-selected="true">CRM</a>
              </li>
              <li class="nav-item">
                <a class="" data-toggle="tab" href="#project" role="tab" aria-controls="home" aria-selected="true">Project</a>
              </li>
              <li class="nav-item">
                <a class="" data-toggle="tab" href="#hrmpermission" role="tab" aria-controls="home" aria-selected="true">HRM</a>
              </li>
              <li class="nav-item">
                ...
                <div class="">
                    <div class="tab-content tab-bordered">
                        ...
                        <div class="tab-pane fade show " id="crm" role="tabpanel">
                          @php
                             $modules=['lead','pipeline','lead stage','source','label','deal','task','stage'];
                          @endphp
                          <div class="col-md-12">
                              <div class="form-group">
                                  @if(!empty($permissions))
