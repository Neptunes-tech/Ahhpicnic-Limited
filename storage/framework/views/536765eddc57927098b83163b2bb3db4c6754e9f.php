                    ...
                    <div class="card-body">
                        <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <span class="d-block h6 mb-0"><?php echo e(__(\App\Project::$project_status[$status])); ?></span>
                                </div>
                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-<?php echo e(\App\Project::$status_color[$due_project->status]); ?>"><?php echo e(\App\Project::$project_status[$due_project->status]); ?></span>
                                                        </div>
                                                        <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\gasilab\resources\views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>