...
<div class="sidenav custom-sidenav" id="sidenav-main">
    ...
    height: 67px;}' src="<?php echo e($logo.'/'.(isset($company_logo) && !empty($company_logo)?$company_logo:'logo.png')); ?>" class="navbar-brand-img"/>
        </a>
        <div class="ml-auto">
...
<?php /**PATH D:\Neptune-Techologies\Gasilab-Larvel\Ahhpicnic Limited\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>