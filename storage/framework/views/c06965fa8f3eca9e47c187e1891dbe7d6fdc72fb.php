        ...
        <div class="row top-bar">
            <div class="col-lg-6 col-md-6 left-part">
                <ul>
                    <li>
                        <a href="#">
                            <img src="" style="width: 87px; height: 67px;" alt="logo" height="35px" width="auto" id="logo">
                        </a>
                    </li>
                    <ul id="menu">
...
<?php /**PATH D:\Neptune-Techologies\Gasilab-Larvel\Ahhpicnic Limited\resources\views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>